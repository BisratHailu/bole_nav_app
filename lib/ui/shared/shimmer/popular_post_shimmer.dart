...
class PopularPostShimmer extends StatelessWidget {
  const PopularPostShimmer({super.key});
  ...
  Widget _buildUpperSection() => SizedBox(
        ...
        child: Row(
          children: [_buildLeftSection(),const  SizedBox(width: 15), _buildImage()],
        ),
      );

  Widget _buildLeftSection() => Expanded(
        flex: 2,
        child: Column(
